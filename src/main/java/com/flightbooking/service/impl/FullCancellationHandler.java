...
@Service
public class FullCancellationHandler extends CancellationTemplate {

    public FullCancellationHandler(BookingRepository bookingRepository, SeatLockService seatLockService) {
